...
import UI.BedsDashboard1;
import UI.BedsDashboard2;
...
public class BedsDashboard extends javax.swing.JFrame {
Connection conn;
...
private int customerId;
    ...
    private void initComponents() {
        ...
        btncsb = new javax.swing.JButton();
        ...
        btncsb.setBackground(new java.awt.Color(101, 101, 101));
        btncsb.setFont(new java.awt.Font("SansSerif", 1, 16)); // NOI18N
        btncsb.setForeground(new java.awt.Color(255, 255, 255));
        btncsb.setText("CHILDRENS/SINGLE");
        btncsb.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btncsbActionPerformed(evt);
            }
        });
        getContentPane().add(btncsb, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 470, 200, 50));

        btndb.setBackground(new java.awt.Color(101, 101, 101));
        btndb.setFont(new java.awt.Font("SansSerif", 1, 16)); // NOI18N
        btndb.setForeground(new java.awt.Color(255, 255, 255));
        btndb.setText("DOUBLE BEDS");
        btndb.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btndbActionPerformed(evt);
            }
        });
        getContentPane().add(btndb, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 470, 180, 50));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Beds/Single Bed.jpg"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, 230, 180));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Beds/Children Beds.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 260, 230, 180));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Beds/DoubleBed1.jpg"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 260, 230, 180));
        ...
        jLabel4.setText("BEDS FURNITURE");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 90, -1, -1));
    ...
    private void btncsbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncsbActionPerformed
        BedsDashboard1 obj = new BedsDashboard1();
        obj.setVisible(true);
        dispose();
    }//GEN-LAST:event_btncsbActionPerformed

    private void btndbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndbActionPerformed
         BedsDashboard2 obj = new BedsDashboard2();
        obj.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BedsDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BedsDashboard().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btncsb;
