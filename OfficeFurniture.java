...
import UI.OfficeChairs;
import UI.OfficeDesk;
import UI.OfficeLongDesk;
 ...
 * @author jessa
 */
public class OfficeFurniture extends javax.swing.JFrame {
Connection conn;
PreparedStatement pst;
ResultSet rst;
private int customerId;
    /**
     * Creates new form OfficeFurniture
     */
    ...
    private void initComponents() {
        ...
        deskbutton = new javax.swing.JButton();
        OfficeChairsbutton = new javax.swing.JButton();
        officedeskbutton = new javax.swing.JButton();
        ...
        deskbutton.setBackground(new java.awt.Color(101, 101, 101));
        deskbutton.setFont(new java.awt.Font("SansSerif", 1, 16)); // NOI18N
        deskbutton.setForeground(new java.awt.Color(255, 255, 255));
        deskbutton.setText("DESK");
        deskbutton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deskbuttonActionPerformed(evt);
            }
        });
        getContentPane().add(deskbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 440, 180, 50));

        OfficeChairsbutton.setBackground(new java.awt.Color(101, 101, 101));
        OfficeChairsbutton.setFont(new java.awt.Font("SansSerif", 1, 16)); // NOI18N
        OfficeChairsbutton.setForeground(new java.awt.Color(255, 255, 255));
        OfficeChairsbutton.setText("CHAIRS");
        OfficeChairsbutton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                OfficeChairsbuttonActionPerformed(evt);
            }
        });
        getContentPane().add(OfficeChairsbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 440, 180, 50));

        officedeskbutton.setBackground(new java.awt.Color(101, 101, 101));
        officedeskbutton.setFont(new java.awt.Font("SansSerif", 1, 16)); // NOI18N
        officedeskbutton.setForeground(new java.awt.Color(255, 255, 255));
        officedeskbutton.setText("LONG DESK");
        officedeskbutton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                officedeskbuttonActionPerformed(evt);
            }
        });
        getContentPane().add(officedeskbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 440, 180, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/OfficeFurniture/Desk.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 240, 230, 180));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/OfficeFurniture/Office Chair.jpg"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 240, 230, 180));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/OfficeFurniture/LongDesk.jpg"))); // NOI18N
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 240, 230, 180));
        ...
        jLabel2.setText("OFFICE FURNITURE");
    ...
    private void deskbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deskbuttonActionPerformed
       OfficeDesk obj = new OfficeDesk();
       obj.setVisible(true);
       dispose();
    }//GEN-LAST:event_deskbuttonActionPerformed

    private void OfficeChairsbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OfficeChairsbuttonActionPerformed
       OfficeChairs obj = new OfficeChairs();
       obj.setVisible(true);
       dispose();
    }//GEN-LAST:event_OfficeChairsbuttonActionPerformed

    private void officedeskbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_officedeskbuttonActionPerformed
        OfficeLongDesk obj = new OfficeLongDesk();
       obj.setVisible(true);
       dispose();
    }//GEN-LAST:event_officedeskbuttonActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OfficeFurniture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton OfficeChairsbutton;
    private javax.swing.JButton OrderTracking;
    private javax.swing.JButton OrdersButton;
    private javax.swing.JButton deskbutton;
    ...
    private javax.swing.JButton officedeskbutton;
