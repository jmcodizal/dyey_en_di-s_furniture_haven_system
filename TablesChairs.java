...
import UI.DiningTablesDashboard;
import UI.CoffeeTables;
import UI.Stools;
 ...
 * @author jessa
 */
public class TablesChairs extends javax.swing.JFrame {
Connection conn;
PreparedStatement pst;
ResultSet rst;
private int customerId;
    /**
     * Creates new form TablesChairs
     */
    public TablesChairs() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btndiningtables = new javax.swing.JButton();
        btncoffeetables = new javax.swing.JButton();
        btnstools = new javax.swing.JButton();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/TablesChairs/Bar Chairs.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 220, 230, 180));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/TablesChairs/Dining Tables.jpg"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 220, 230, 180));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/TablesChairs/Coffee Tables.jpg"))); // NOI18N
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 220, 230, 180));

        btndiningtables.setBackground(new java.awt.Color(101, 101, 101));
        btndiningtables.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        btndiningtables.setForeground(new java.awt.Color(255, 255, 255));
        btndiningtables.setText("DINING TABLES");
        btndiningtables.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btndiningtablesActionPerformed(evt);
            }
        });
        getContentPane().add(btndiningtables, new org.netbeans.lib.awtextra.AbsoluteConstraints(1120, 420, 180, 50));

        btncoffeetables.setBackground(new java.awt.Color(101, 101, 101));
        btncoffeetables.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        btncoffeetables.setForeground(new java.awt.Color(255, 255, 255));
        btncoffeetables.setText("COFFEE TABLES");
        btncoffeetables.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btncoffeetablesActionPerformed(evt);
            }
        });
        getContentPane().add(btncoffeetables, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 420, 180, 50));

        btnstools.setBackground(new java.awt.Color(101, 101, 101));
        btnstools.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        btnstools.setForeground(new java.awt.Color(255, 255, 255));
        btnstools.setText("STOOLS");
        btnstools.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnstoolsActionPerformed(evt);
            }
        });
        getContentPane().add(btnstools, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 420, 180, 50));
        ...
        jLabel5.setText("TABLES AND CHAIRS FURNITURE");
    ...
    private void btncoffeetablesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncoffeetablesActionPerformed
       CoffeeTables obj = new CoffeeTables();
       obj.setVisible(true);
       dispose();
    }//GEN-LAST:event_btncoffeetablesActionPerformed

    private void btnstoolsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnstoolsActionPerformed
        Stools obj = new Stools();
        obj.setVisible(true);
        dispose();
    }//GEN-LAST:event_btnstoolsActionPerformed

    private void btndiningtablesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndiningtablesActionPerformed
        DiningTablesDashboard obj = new DiningTablesDashboard();
        obj.setVisible(true);
        dispose();
    }//GEN-LAST:event_btndiningtablesActionPerformed
 ...
 LocalDateTime now = LocalDateTime.now();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablesChairs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablesChairs().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btncoffeetables;
    private javax.swing.JButton btndiningtables;
    private javax.swing.JButton btnstools;
